<%*
// Demande le nom du personnage (et renomme le fichier)
const nomPJ = await tp.system.prompt("Nom du Personnage", "");
const safeName = (nomPJ && nomPJ.trim().length) ? nomPJ.trim() : "PJ Sans Nom";
