...
> *« Gardiens de la vase, chanteurs de la brume, dormeurs des eaux terreuses. »*
...
Survie par pêche, cueillette et chasse d’insectes géants ; ils déposent parfois des charognes pour attirer des nuées… ou répandre maladies et fièvres.

Ils vivent sur **radeaux communautaires** et **villages sur pilotis** (bambous, bois, boue séchée, briques d’argile). Sous les eaux : galeries naturelles, caches et sanctuaires submergés. Le centre rituel abrite un **Cœur de Vase** (communion, offrandes, sacrifices, hibernation historique).

Amphibiens à peau lisse et luisante : adultes brillants et colorés ; très jeunes et très vieux ternes et gris (compensés par des bijoux). Tatouages en motifs (piqûres de moustiques géants trempés dans la tourbe).
...
Le **Goll-Tout** est structuré en clans territoriaux (*Chose-Goll*), chacun portant un nom en `*****-Goll` :
- **Souch-Goll** (forêts)
- **Brouss-Goll** (plaines)
- **Roc-Goll** (zones montagneuses)
- **Vase-Goll** (Marais Central, rang supérieur)

Les zones les plus sacrées sont marquées par les **Statues-Chamans**, les mares de rites et les passages submergés.

## Organisation interne

Le peuple est officiellement dirigé par **Nénuvaar Milmouch**, Grand Chef historique, mais il demeure en hibernation au fond de la vase. En pratique, l’autorité est exercée par les **Sachants**, anciens chamaniques et gardiens du dogme de la Vase Vivante.

| Caste / Rang | Rôle | Description | Particularité |
| --- | --- | --- | --- |
| **Nénuvaar Milmouch** | Grand Chef (hibernation) | Chef mythique et attendu. | Taille démesurée ; son réveil est l’espoir du peuple. |
| **Sachants** | Dirigeants / chamans | Un par **Statue-Chaman** ; chants magiques, tradition, loi. | Ornementation vive (bijoux) compensant une peau terne. |
| **Hérauts de la Tourbe** | Gardes sacrés | Armes vivantes, élevées en mares secrètes. | Spores hallucinogènes + chair sacrificielle ; violents, imprévisibles. |
| **Kroa’hr** | Vétérans / agents | Terrain (pêche, chasse, cueillette) + maintien de l’ordre. | Autorité locale, veillent au respect des rites. |
| **Sabrilles** | Main d’œuvre | Adultes aux peaux brillantes ; exécutants. | Obéissance aux Kroa’hr. |
| **Mueurs** | Apprentis | Jeunes adultes ; jeux, création, apprentissages. | Période instable avant pleines fonctions. |
