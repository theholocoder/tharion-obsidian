---
type: note
parent: "[[S004 - L'épave de la Clef d'Ecume]]"
tags:
  - session
  - idees
  - recuperation
...
- 3 decks : **upper**, **middle**, **lower**.
- Upper + middle : intacts.
- Lower : ouvert **de part en part** (brèche sur toute la largeur), navire posé sur fond rocheux.

## Rencontres (max 3 combats)

### Combat 1 — extérieur : prédateurs
- Prédateurs attirés par le sang et les débris (requins / banc carnivore / autre).
- But : mise sous pression immédiate, consommer quelques ressources avant l’entrée.

### Rencontre 2 — middle deck : Azarketi (neutres)
...
- Restes de **cage scellée** + **ancre-sceau** brisée (iconographie chaîne/obéissance, motifs de ténèbres/secret).
- Traces d’inspection : gants/cire noire, ligatures, plaques gravées sans nom explicite.
- Débris “récemment fouillés” (cohérent avec les hommes aux chaînes noires revenus sur place).
